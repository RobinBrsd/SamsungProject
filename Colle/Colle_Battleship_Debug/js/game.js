...
(function () {
    ...
    var game = {
        ...
        renderMiniMap: function () {
            ...
            var row = this.miniGrid.children;
            ...
            for(let i = 0; i < grid.length; i++) {
                for (let j = 0; j < grid.length; j++){
                    if(grid[i][j] != 0) {
                        if(grid[i][j] ===  1) {
                            row[i].children[j].style.backgroundColor = "red";
                        }
                        
                        if(grid[i][j] === 2) {
                            row[i].children[j].style.backgroundColor = "lightblue";
                        }
                        
                        if(grid[i][j] === 3) {
                            row[i].children[j].style.backgroundColor = "lightgreen";
                        }
